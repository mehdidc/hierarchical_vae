...
def load_dataset(dataset_name, split="full"):
    if dataset_name == "mnist":
        ...
        dataset = dset.ImageFolder(
            root=data_path("shoes/ut-zap50k-images"),
            transform=transforms.Compose(
                [
                    transforms.Scale(64),
                    transforms.CenterCrop(64),
        ...
        dataset = dset.ImageFolder(
            root=data_path("fonts/full"),
            transform=transforms.Compose([transforms.ToTensor(), Invert(), Gray()]),
        )
        return dataset
    else:
        dataset = dset.ImageFolder(
